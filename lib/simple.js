 ...
 */
    ...
    */
     ...
     * @param {Object} options
     */
     async sendButtonDoc(jid, buffer, content, footer, button1, row1, quoted, options = {}) {
      return await this.sendMessage(jid, {
        contentText: content,
        footerText: footer,
        buttons: [
    ...
    async send2ButtonDoc(jid, buffer, content, footer, button1, row1, button2, row2, quoted, options = {}) {
      return await this.sendMessage(jid, {
        contentText: content,
        footerText: footer,
        buttons: [
    ...
    async send3ButtonDoc(jid, buffer, content, footer, button1, row1, button2, row2, button3, row3, quoted, options = {}) {
      return await this.sendMessage(jid, {
        contentText: content,
        footerText: footer,
        buttons: [
    ...
    /**
     * Reply to a Audio (External Ad Reply)
     * Added By SafwanGanz
     * @param {String} jid
     ...
     * @param {Object} options
     */
    async adReplyAud(jid, buffer1, title, body, link, buffer, quoted, options = {}) {
    return await this.sendMessage(jid, buffer1, MessageType.audio, {mimetype: 'audio/mp4', contextInfo: { mentionedJid , quoted, externalAdReply: {title: title, body: body, previewType:"PHOTO", thumbnail: buffer,sourceUrl: link }}})
    }			
     /**
     * Reply to a message (External Ad Reply)
     * Added By SafwanGanz
     * @param {String} jid
     * @param {String} title
     * @param {String} body
     ...
     * @param {Object} options
     */
    async adReply(jid, text, title, body, link, buffer, quoted, options = {}) {
    return await this.sendMessage(jid, text, MessageType.text, { contextInfo: { mentionedJid: this.parseMention(text) , quoted, externalAdReply: {title: title, body: body, previewType:"PHOTO", thumbnail: buffer,sourceUrl: link }}})
    }			
    /**
     * Reply to a message
     * @param {String} jid
